    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-neutral-900">Customer Login</h1>
          <p className="mt-1 text-sm text-neutral-500">Track your repairs and manage your account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-card border border-neutral-200 p-8">
          {step === 'phone' ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-2.5 border border-neutral-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    required
                  />
                </div>
              </div>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div className="text-center mb-2">
                ...
                <p className="text-sm text-neutral-600">OTP sent to <span className="font-semibold">+91 {phone}</span></p>
                <button type="button" onClick={() => setStep('phone')} className="text-xs text-primary-600 hover:underline mt-0.5">Change number</button>
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="• • • • • •"
                  className="w-full text-center text-xl tracking-[0.5em] px-4 py-2.5 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  required
                />
              </div>
              <button
          ...
          <div className="mt-6 pt-5 border-t border-neutral-100 text-center">
            <p className="text-sm text-neutral-500">
              New customer?{' '}
              <Link href="/portal/register" className="text-primary-600 font-medium hover:underline">
                Create account
              </Link>
            </p>
          </div>
